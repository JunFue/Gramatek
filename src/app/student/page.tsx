...
export default async function StudentDashboard() {
  ...
  return (
    <div className="p-6 md:p-8 max-w-6xl mx-auto animate-fade-in relative z-10 space-y-10">
      
      {/* Top Row: Join Classroom & Welcome Banner */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        {/* Join Classroom Card */}
        <div className="lg:col-span-1 card p-8 relative overflow-hidden flex flex-col justify-between">
          <div>
        ...
        <div className="lg:col-span-2 rounded-3xl p-8 bg-brand-primary text-white flex flex-col justify-center shadow-lg relative overflow-hidden">
          <div className="flex items-center gap-2 mb-2">
          ...
          <h2 className="text-3xl md:text-4xl font-heading font-black mb-2 text-white">
          ...
          <div className="flex flex-wrap items-center gap-4 mt-6">
            <Link 
              ...
              className="px-6 py-3 bg-brand-light text-brand-primary hover:bg-white rounded-xl font-black text-sm transition-all shadow-md active:scale-95 flex items-center gap-2"
            >
              <span>🎮 <Translate fil="Maglaro ng Palarong Handa (3 Antas)" en="Play Built-in Games (3 Levels)" /></span> ➔
            </Link>

            <div className="bg-white/10 rounded-xl px-4 py-2 border border-white/20 flex items-center gap-3">
              <p className="text-white/70 text-xs font-bold uppercase tracking-wider">
                <Translate fil="Nilahukang Silid" en="Enrolled Rooms" />:
              </p>
              <p className="text-xl font-black text-white">{enrollments?.length || 0}</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              <span className="text-xl">🏆</span>
              <h3 className="text-xl font-heading font-black text-brand-primary">
            ...
            <p className="text-[#5a6b5a] text-sm font-semibold max-w-2xl">
              <Translate 
            ...
            <div className="flex flex-wrap gap-2 pt-2">
              <span className="px-3 py-1 bg-white text-slate-700 text-xs font-bold rounded-lg border border-slate-200 shadow-xs">
          ...
          <Link 
            href="/student/practice" 
            className="px-6 py-3.5 bg-brand-primary hover:bg-slate-600 text-white rounded-2xl font-extrabold text-sm transition-all shadow-md active:scale-95 text-center shrink-0 flex items-center justify-center gap-2"
          >
      ...
      <div>
        ...
        {enrollments && enrollments.length > 0 ? (
          ...
          <div className="card p-12 text-center flex flex-col items-center justify-center">
            ...
            <p className="text-[#5a6b5a] max-w-md mx-auto font-semibold">
              <Translate 
