...
export default function LandingPage() {
 ...
 <button type="submit" className="btn-outline text-sm px-5 py-2">
 <Translate fil="Mag-sign In" en="Sign In" />
 </button>
 </form>
 </nav>
 ...
 <form action={signInWithGoogle}>
 <button type="submit" className="btn-primary text-xl px-10 py-5 rounded-2xl shadow-md hover:shadow-lg hover:-translate-y-1 transition-all">
 <Translate fil="Magsimula nang Libre!" en="Start for Free!" />
 </button>
 </form>
 </div>
