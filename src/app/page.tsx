...
export default function LandingPage() {
 ...
 <div className="glass-strong card-hover rounded-[2.5rem] p-8 flex flex-col items-center text-center md:col-span-2 border-b-8 border-brand-secondary/40 shadow-xl">
 <div className="w-16 h-16 rounded-3xl bg-brand-secondary/15 flex items-center justify-center mb-6">
 <Gamepad2 className="w-8 h-8 text-brand-secondary" />
 </div>
 <h3 className="text-3xl font-heading font-extrabold text-brand-primary mb-3">Masasayang Pagsusulit</h3>
 <p className="text-slate-700 font-bold text-lg leading-relaxed">Pabonggahin ang husay mo sa napakasayang laro ng questions and answers. Mas madali at mas mabilis matuto!</p>
 </div>

 <div className="glass-strong card-hover rounded-[2.5rem] p-8 flex flex-col items-center text-center border-b-8 border-brand-primary/40 shadow-xl">
 <div className="w-16 h-16 rounded-3xl bg-brand-primary/15 flex items-center justify-center mb-6">
 <Star className="w-8 h-8 text-brand-primary " />
 </div>
 <h3 className="text-3xl font-heading font-extrabold text-brand-primary mb-3">Silid-Aralan</h3>
 <p className="text-slate-700 font-bold text-lg leading-relaxed">Lahat ng laro at aralin mo, nandito lang sa iisang makulay na kwarto.</p>
 </div>

 <div className="glass-strong card-hover rounded-[2.5rem] p-8 flex flex-col items-center text-center border-b-8 border-brand-accent/40 shadow-xl">
 <div className="w-16 h-16 rounded-3xl bg-amber-400/20 flex items-center justify-center mb-6">
 <BrainCircuit className="w-8 h-8 text-amber-500" />
 </div>
 <h3 className="text-3xl font-heading font-extrabold text-brand-primary mb-3">Suportado ng AI</h3>
 <p className="text-slate-700 font-bold text-lg leading-relaxed">Mabilisang makagawa ng mga bagong nakakatuwang laro sa isang iglap.</p>
 </div>

 <div className="glass-strong card-hover rounded-[2.5rem] p-8 flex flex-col items-center text-center md:col-span-2 relative overflow-hidden border-b-8 border-pink-400/40 shadow-xl">
 <div className="absolute -right-4 -bottom-4 opacity-10 pointer-events-none">
 <HeartPulse className="w-64 h-64 text-pink-500" />
 </div>
 <div className="relative z-10 w-full h-full flex flex-col items-center">
 <div className="w-16 h-16 rounded-3xl bg-pink-500/15 flex items-center justify-center mb-6">
 <Star className="w-8 h-8 text-pink-500" />
 </div>
 <h3 className="text-3xl font-heading font-extrabold text-brand-primary mb-3">Pagsusuri ng Galing</h3>
 <p className="text-slate-700 font-bold text-lg max-w-md leading-relaxed">Makita kung gaano ka na kagaling! Masusurpresa ka kung gaano kadami ang iyong natutunan.</p>
 </div>
 </div>
